...
### ANSWER ###
features1, class_labels1 = make_classification(n_features = 2, n_informative = 1, n_redundant = 0, n_clusters_per_class = 1)
features2, class_labels2 = make_classification(n_features = 2, n_informative = 2, n_redundant = 0, n_clusters_per_class = 1)
features3, class_labels3 = make_classification(n_features = 4, n_informative = 2, n_redundant = 2, n_clusters_per_class = 1)
features4, class_labels4 = make_classification(n_features = 4, n_informative = 2, n_redundant = 2, n_clusters_per_class = 2)
